...
void C3dglTerrain::render(glm::mat4 matrix)
{
	...
	if (pProgram)
	{
		...
		GLuint attribTangent = pProgram->GetAttribLocation(C3dglProgram::ATTR_TANGENT);
		GLuint attribBiTangent = pProgram->GetAttribLocation(C3dglProgram::ATTR_BITANGENT);
